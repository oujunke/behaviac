...
namespace behaviac
{
	...
	public class BehaviorLoaderImplement : BehaviorLoader
	{
		...
		{
			AgentMeta.GetMetaGlobal(Workspace).TotalSignature = 3155468577;
			...
			// FirstAgent
			meta = new AgentMeta(Workspace,2701430383);
			...
			meta.RegisterMethod(664995375, new CAgentMethodVoid(delegate(Agent self) {return ((FirstAgent)self).Start();}, Workspace));
			meta.RegisterMethod(2065006847, new CAgentMethodVoid<int>(delegate(Agent self, int param0) {return Task.CompletedTask; }, Workspace) /* t1 */);
			meta.RegisterMethod(2521019022, new CMethod_behaviac_Agent_VectorAdd(Workspace));
			meta.RegisterMethod(2306090221, new CMethod_behaviac_Agent_VectorClear(Workspace));
			meta.RegisterMethod(3483755530, new CMethod_behaviac_Agent_VectorContains(Workspace));
			meta.RegisterMethod(505785840, new CMethod_behaviac_Agent_VectorLength(Workspace));
			meta.RegisterMethod(502968959, new CMethod_behaviac_Agent_VectorRemove(Workspace));
			meta.RegisterMethod(994837275, new CAgentMethod<behaviac.EBTStatus>(delegate(Agent self) { return ((FirstAgent)self).Wait();}, Workspace));
