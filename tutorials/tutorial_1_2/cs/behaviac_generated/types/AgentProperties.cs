...
namespace behaviac
{
	...
	public class BehaviorLoaderImplement : BehaviorLoader
	{
		...
		{
			AgentMeta.GetMetaGlobal(Workspace).TotalSignature = 3940253444;
			...
			// SecondAgent
			meta = new AgentMeta(Workspace,3772742788);
			AgentMeta.GetMetaGlobal(Workspace)._AgentMetas_[2432194202] = meta;
			meta.RegisterMemberProperty(2082220067, new CMemberProperty<int>("p1", delegate(Agent self, int value) { ((SecondAgent)self)._set_p1(value); }, delegate(Agent self) { return ((SecondAgent)self)._get_p1(); }, Workspace));
			...
			meta.RegisterMethod(1759647744, new CAgentMethodVoid<string>(delegate(Agent self, string value) {return ((SecondAgent)self).m1(value);}, Workspace));
			meta.RegisterMethod(2521019022, new CMethod_behaviac_Agent_VectorAdd(Workspace));
			meta.RegisterMethod(2306090221, new CMethod_behaviac_Agent_VectorClear(Workspace));
			meta.RegisterMethod(3483755530, new CMethod_behaviac_Agent_VectorContains(Workspace));
			meta.RegisterMethod(505785840, new CMethod_behaviac_Agent_VectorLength(Workspace));
