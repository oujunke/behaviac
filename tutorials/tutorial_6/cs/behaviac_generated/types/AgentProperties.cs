...
namespace behaviac
{
	...
	public class BehaviorLoaderImplement : BehaviorLoader
	{
		...
		{
			AgentMeta.GetMetaGlobal(Workspace).TotalSignature = 1527488372;
			...
			// FirstAgent
			meta = new AgentMeta(Workspace,278411645);
			...
			meta.RegisterMethod(3345343196, new CAgentMethodVoid<int>(delegate(Agent self, int param0) {return Task.CompletedTask; }, Workspace) /* event_task */);
			...
			meta.RegisterMethod(702722749, new CAgentMethodVoid<string>(delegate(Agent self, string param0) {return ((FirstAgent)self).Say(param0);}, Workspace));
			meta.RegisterMethod(2521019022, new CMethod_behaviac_Agent_VectorAdd(Workspace));
			meta.RegisterMethod(2306090221, new CMethod_behaviac_Agent_VectorClear(Workspace));
			meta.RegisterMethod(3483755530, new CMethod_behaviac_Agent_VectorContains(Workspace));
			meta.RegisterMethod(505785840, new CMethod_behaviac_Agent_VectorLength(Workspace));
